...
<div class="card-body" markdown="1">
REDCap is pretty easy to use, but there's little documentation, and some clever and important functions aren't obvious. We'll show you what we've learned.
