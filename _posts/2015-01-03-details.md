...
<div class="card-body" markdown="1">
Come here if you'd like to learn about programming, but have little to no prior experience.
...
**You'll need:** Just you - computer and SPSS will be provided in lab.
...
**What you'll need:** A laptop (optional)
...
<div class="card-body" markdown="1">
Adobe Photoshop can be a very powerful and versatile tool for creating scientific figures, but may seem unintuitive or overwhelming for an inexperienced user. Using some microscopy image data as an example, we'll cover the all the steps in creating a figure for publication and address some of the ethical considerations when presenting your data. 
...
**You'll need:** Laptop with Photoshop installed (optional)
...
<div class="card-body" markdown="1">
REDCap is pretty easy to use, but there's little documentation, and some clever and important functions aren't obvoius. We'll show you what we've learned.

**You'll learn:**

- Helpful in-built tools and functions that REDCap has but few use (e.g., action tags, if statements, automation)
- How and why to use dynamic SQL and the API
- How to design to make data-entry foolproof (e.g., building flags, creating help popups)
